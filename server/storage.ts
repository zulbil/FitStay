...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    // Seed coaches - Comprehensive database of 40 coaches
    const coachData = [
      {
        slug: "sarah-chen",
        ...
        city: "San Francisco",
        country: "USA",
        address: "1247 Mission Street, San Francisco, CA 94103, USA",
        lat: 37.7749,
        lng: -122.4194,
      ...
      },
      {
        ...
        city: "Austin",
        country: "USA",
        address: "892 Barton Springs Rd, Austin, TX 78704, USA",
        lat: 30.2672,
        lng: -97.7431,
      ...
      },
      {
        ...
        city: "Denver",
        country: "USA",
        address: "1456 Pearl Street, Boulder, CO 80302, USA",
        lat: 40.0150,
        lng: -105.2705,
      ...
      },
      {
        ...
        city: "Portland",
        country: "USA",
        address: "2341 NW Westover Rd, Portland, OR 97210, USA",
        lat: 45.5152,
        lng: -122.6784,
      ...
      },
      {
        ...
        city: "Los Angeles",
        country: "USA",
        address: "8642 Melrose Ave, West Hollywood, CA 90069, USA",
        lat: 34.0837,
        lng: -118.3723,
